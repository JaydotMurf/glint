    ...
    extend: {
      colors: {
        ...
        flashcard: {
          ...
          foreground: "hsl(var(--flashcard-foreground))",
        },
        sidebar: {
      ...
      fontSize: {
        "display": ["3rem", { lineHeight: "1.1", letterSpacing: "-0.03em", fontWeight: "800" }],
        "display-sm": ["2.25rem", { lineHeight: "1.15", letterSpacing: "-0.02em", fontWeight: "700" }],
        "heading": ["1.75rem", { lineHeight: "1.25", letterSpacing: "-0.02em", fontWeight: "700" }],
      ...
      boxShadow: {
        ...
        "card": "0 1px 3px rgba(0, 0, 0, 0.05), 0 10px 30px -10px rgba(0, 0, 0, 0.1)",
        "elevated": "0 25px 50px -12px rgba(0, 0, 0, 0.15)",
        "glow-primary": "0 0 50px -12px hsl(235 85% 65% / 0.4)",
        "glow-success": "0 0 50px -12px hsl(162 72% 45% / 0.4)",
        "glow-accent": "0 0 50px -12px hsl(172 66% 50% / 0.4)",
        "inner-glow": "inset 0 2px 20px 0 hsl(var(--primary) / 0.1)",
      },
      backgroundImage: {
        "gradient-radial": "radial-gradient(var(--tw-gradient-stops))",
        "gradient-conic": "conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))",
        "hero-gradient": "linear-gradient(135deg, hsl(var(--primary) / 0.15) 0%, hsl(280 85% 65% / 0.1) 50%, hsl(var(--accent) / 0.15) 100%)",
